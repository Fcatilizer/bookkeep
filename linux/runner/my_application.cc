...
static void my_application_activate(GApplication *application)
{
  ...
  if (use_header_bar)
  {
    ...
    gtk_header_bar_set_title(header_bar, "bookkeep");
    gtk_header_bar_set_show_close_button(header_bar, TRUE);
    gtk_window_set_titlebar(window, GTK_WIDGET(header_bar));
  }
  else
  {
    gtk_window_set_title(window, "bookkeep");
  }
  ...
  const char *icon_paths[] = {
      ...
      "assets/icon.png",
      "/usr/share/icons/hicolor/512x512/apps/bookkeep.png",
      "/usr/share/pixmaps/bookkeep.png",
      NULL};

  for (int i = 0; icon_paths[i] != NULL && icon == NULL; i++)
  {
